      ...
      <TouchableOpacity style={styles.container} activeOpacity={1} onPress={() => Keyboard.dismiss()}>
        <View style={styles.contentView}>
          ...
          <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}>
            <RoundButton style={styles.button} theme="theme2" title="REVIEW NDA" floatSize={true} onPress={() => this.onReviewNDA()}></RoundButton>
            <RoundButton style={styles.button} title="SEND NDA" floatSize={true} isLoading={this.state.is_loading} onPress={() => this.onSendNDA()}></RoundButton>
            {
